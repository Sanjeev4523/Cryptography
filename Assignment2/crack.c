...
// rf = fopen("ciphertext.txt","r");
// wf = fopen("recovered.txt","w");
// UINT ckey8[2]={0,0};
//  UINT ckey10 = cbin2UINT("0000100000",KEYSIZE);
//  BYTE cinput8 = (BYTE) cbin2UINT("00100000",BLOCKSIZE), cexInput8, ci;
//  /** left and Right */
//  BYTE cLR[] ={00,00};
//  char cuserKey[]="0000000000",cuserText[]="0000000000";
// ckey10 = cbin2UINT(userKey,KEYSIZE);
// keySchedule(ckey10,ckey8);
// while(! feof(rf)){
// 	cinput8 = (BYTE) fgetc(rf);
// 	//itoa(temp,userText,2);
// 	//printf("plaintext: %s",userText);
// 	//input8 = (BYTE) cbin2UINT(userText,BLOCKSIZE);
// 	printBin(" Plaintext = ", cinput8, BLOCKSIZE);
// 	putchar('\n');
// 	cinput8 = per(IP,cinput8);
// 	cexInput8 = cinput8;
// 	 for(i=0; i< 2; i++){
// 	 /** =====> begin round */
// 	 split824(cexInput8,cLR);
// 	 cinput8 = (f(cLR[1],(BYTE)ckey8[(i+1)%2])^cLR[0]) << 4; //WAPIANG!! Sai mu sai ah..
// 	 cinput8 |= cLR[1];
// 	 cexInput8 = ((cinput8 & 240) >> 4) | ( (cinput8 & 15) << 4 );
	 
// }
// cinput8 = per(IP_1,cinput8);
// printBin(" Ciphertext = ", cinput8, BLOCKSIZE);
// putchar('\n');
// fprintf(wf, "%c", input8 );
// //printf("plaintext2: %s",userText);
// }
// fclose(rf);
// fclose(wf);
